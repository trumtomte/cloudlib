...
The `Request` object provides simple methods for getting/validating $_SERVER variables.
...
[Helpers Wiki](https://github.com/trumtomte/cloudlib/wiki)
`NOTE` as this is under active development the examples has not yet been written, however you can view all class methods.
